...
model_path = r'D:\Introduction to Deep Learning (Praktek)\Introduction to Deep Learning (Praktek)\best_model_tf.h5'
...
if os.path.exists(model_path):
    try:
        ...
        st.title('Fashion MNIST Image Classification 1478')
